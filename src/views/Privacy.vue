<template>
    <div class="background">
        ...
        <body id="iljx">
            ...
            <section class="bdg-sect">
                <h1 class="heading">Methods of processing Data
                </h1>
                <span id="ilg2">Peppubuild doesn't store user personal information or date. All data is stored in Firebase.
            ...
            <section class="bdg-sect">
                <h1 class="heading">Changes to Policy
                </h1>
